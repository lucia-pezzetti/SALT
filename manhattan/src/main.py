...
parser.add_argument("--print_q_cycle_diagnostics", action="store_true", help="For failed learned-Q trajectories, print repeated-cycle action, Q-value, shortest-path, and signal diagnostics (requires --print_eval_trajectories).")
