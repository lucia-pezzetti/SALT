...
obs_fn = make_obs_fn(G_fds, node_to_idx, env.max_steps)
...
has_path_fn = make_has_path_fn(G_fds, idx_to_node)
...
file_path = os.path.join(output_dir, f"trained_agent_{timestamp}.eqx")

with open(file_path, "wb") as f:
    eqx.tree_serialise_leaves(f, trained_agent, is_leaf=eqx.is_array)

print(f"Trained agent saved to {file_path}")
